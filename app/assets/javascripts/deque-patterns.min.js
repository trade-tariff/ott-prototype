    ...
    return (
        (n = [
                ...
                function y(e, r) {
                    ...
                    function f(e) {
                        e.classes && d(e.classes),
                            ...
                            (function (e) {
                                if (!e.isAlert) {
                                    var t = (0, v.getFirstFocusableChild)(n);
                                    if (
                                        (t = t.classList.contains("deque-dialog-button-close")
                                            ? (0, v.getNextFocusableChild)(n, t)
                                            : t)
                                    )
                                        return t.focus();
                                }
            ...
            function (e, t, r) {
                "use strict";
                Object.defineProperty(t, "__esModule", { value: !0 }),
                    (t.createThumbControl = function (n, i, a, o, t, r) {
                        ...
                        if (i.initialValue < a || i.initialValue > o)
                            throw new Error(
                        ...
                        function c(e) {
                            for (
                                var t = n.getAttribute("aria-valuenow"),
                        ...
                        function f() {
                            ...
                            var e = n.getAttribute("aria-valuenow");
                            d(parseFloat(e));
                        }
                        p.onElementRight(n, function (e) {
                            e.preventDefault(), e.stopPropagation(), c(i.stepSize);
                        }),
                            ...
                            p.onElementPageUp(n, function (e) {
                                e.preventDefault(), e.stopPropagation(), c(10 * i.stepSize);
                            }),
